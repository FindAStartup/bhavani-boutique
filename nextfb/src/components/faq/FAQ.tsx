...
const FAQItem = ({ question, answer, isOpen, onClick }: FAQItemProps) => {
    return (
        <div className="border border-stone-200 rounded-lg overflow-hidden mb-4 bg-white transition-all duration-300 hover:shadow-sm">
            ...
            >
                <h3
                    className={`font-semibold text-lg ${isOpen ? "text-primary" : "text-slate-800"
                        }`}
                >
                    {question}
                </h3>
...
interface FAQSectionProps {
    ...
    sectionIndex: number;
    openIndex: { section: number; index: number };
        ...
        <div>
            {items.map((item, index) => (
                <FAQItem
                    ...
                    answer={item.answer}
                    isOpen={
                        openIndex.section === sectionIndex && openIndex.index === index
                    }
                    onClick={() => toggleItem(sectionIndex, index)}
                />
            ))}
        </div>
    </div>
    ...
    const faqData = [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    answer:
                        "We process orders quickly. If you need to make changes, please contact us within 2 hours of placing your order at bhavaniboutique167@gmail.com.",
                },
            ],
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    answer:
                        "Currently, we only accept prepaid orders to ensure the fastest delivery experience.",
                },
            ],
        },
        {
            ...
            items: [
                {
                    ...
                    answer:
                        "Yes, we ship globally! International shipping rates and delivery times vary by location and are calculated at checkout.",
                },
                {
                    question: "How long will it take to get my order?",
                    answer:
                        "Domestic orders typically arrive within 5-7 business days. International orders can take 10-15 business days.",
                },
            ],
        },
        {
            ...
            items: [
                {
                    ...
                    answer:
                        "We accept returns for defective or incorrect items within 7 days of delivery. The item must be unused, unwashed, and in its original packaging.",
                },
                {
            ...
            items: [
                {
                    ...
                    answer:
                        "Yes! For select items (like Cordset, Saree), we offer basic customization. Please contact us before placing your order to discuss your requirements.",
                },
                {
                    question: "How do I care for my garments?",
                    answer:
                        "Most of our ethnic wear is delicate. We recommend dry cleaning only for silk, embroidered, and embellished items. Cotton items can be gently hand-washed.",
                },
            ],
        },
    ];
                ...
                <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl">
                    ...
                    <div className="mt-12 text-center bg-white rounded-xl p-8 border border-stone-100 shadow-sm max-w-2xl mx-auto">
                        ...
                        <p className="text-slate-600 mb-6">
                            We are here to help you via email or phone.
                        </p>
                        <a

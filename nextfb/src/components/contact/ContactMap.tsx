...
import { MapPin, Search, Plus, Minus, ExternalLink } from 'lucide-react';
...
const ContactMap = () => {
    return (
        <section className="mb-16 rounded-xl overflow-hidden shadow-sm border border-[#eff0ea] dark:border-[#2a2c22] relative h-[400px] w-full bg-[#e5e5e5] group">
            ...
            >
                <div className="bg-white border border-gray-200 shadow-xl py-2 px-4 rounded-lg relative animate-bounce-slow">
                    <div className="flex items-center gap-2">
                        <MapPin className="w-4 h-4 text-[#708238]" />
                        <p className="font-serif font-bold text-[#161811] text-sm whitespace-nowrap">
                            Bhavani Boutique
                        </p>
                    </div>
            ...
            <div className="absolute top-4 left-4">
                <div className="flex bg-white text-gray-700 rounded-lg shadow-md p-2 items-center gap-2">
                    <Search className="w-4 h-4 text-gray-400" />
                    <input
                        type="text"
                        placeholder="Find our store"
                        className="border-none focus:ring-0 text-sm bg-transparent w-48 outline-none text-gray-700 placeholder:text-gray-400"
                    />
                </div>
            </div>
            ...
            <div className="absolute bottom-6 right-6 flex flex-col gap-2">
                <div className="flex flex-col rounded-lg bg-white shadow-md overflow-hidden">
                    <button className="p-2 border-b border-gray-100 hover:bg-gray-50 text-gray-600">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 rounded-lg bg-white shadow-md hover:bg-gray-50 text-gray-600 transition-colors"

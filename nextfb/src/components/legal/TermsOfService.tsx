        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl">
            <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 border border-stone-100">
                ...
                <div className="space-y-8 text-slate-600 leading-relaxed">
                    <section>
                        <p className="mb-4">
                            Welcome to <strong>Bhavani Boutique</strong>. By accessing or using our website <a href="https://bhavaniboutiques.in" className="text-primary hover:underline">bhavaniboutiques.in</a>, you agree to be bound by these Terms of Service. Please read them carefully.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            All content on this website, including text, graphics, logos, images, and software, is the property of Bhavani Boutique and is protected by copyright laws. You may not use our content without express written permission.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            Bhavani Boutique shall not be liable for any direct, indirect, incidental, or consequential damages arising from your use of our products or website.
                        </p>
                    </section>

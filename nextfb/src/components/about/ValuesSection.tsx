    ...
    return (
        <section className="max-w-[1200px] mx-auto py-32 px-6">
            <div className="text-center mb-20 space-y-4">
                ...
                <div className="w-20 h-px bg-[#708238] mx-auto"></div>
            </div>
            <div className="grid md:grid-cols-3 gap-12">
                <div className="text-center space-y-6">
                    <div className="mx-auto size-16 flex items-center justify-center rounded-full border border-[#708238] transition-colors duration-500">
                        <span className="material-icons-outlined text-[#708238] text-3xl transition-colors duration-500">auto_awesome</span>
                    </div>
                ...
                <div className="text-center space-y-6">
                    <div className="mx-auto size-16 flex items-center justify-center rounded-full border border-[#708238] transition-colors duration-500">
                        <span className="material-icons-outlined text-[#708238] text-3xl transition-colors duration-500">architecture</span>
                    </div>
                ...
                <div className="text-center space-y-6">
                    <div className="mx-auto size-16 flex items-center justify-center rounded-full border border-[#708238] transition-colors duration-500">
                        <span className="material-icons-outlined text-[#708238] text-3xl transition-colors duration-500">eco</span>
                    </div>

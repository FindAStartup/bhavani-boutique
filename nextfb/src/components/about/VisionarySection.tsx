        ...
        <section className="bg-primary/5 dark:bg-primary/10 py-24 overflow-hidden">
            <div className="max-w-[1200px] mx-auto px-6 flex flex-col md:flex-row items-center gap-20">
                <div className="w-full md:w-1/2 relative">
                    <div className="absolute -top-10 -left-10 size-64 bg-brand-gold/10 rounded-full blur-3xl"></div>
                    <div
                ...
                <div className="w-full md:w-1/2 space-y-8">
                    ...
                    <blockquote className="relative">
                        <p className="text-3xl md:text-4xl font-light italic leading-snug text-[#161811] relative z-10 ">

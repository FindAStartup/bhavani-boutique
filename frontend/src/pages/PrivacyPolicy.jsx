                ...
                <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl">
                    <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 border border-stone-100">
                        ...
                        <div className="space-y-8 text-slate-600 leading-relaxed">
                            <section>
                                <p className="mb-4">
                                    At <strong>Bhavana Boutique</strong>, we value your trust and are committed to protecting your privacy. This Privacy Policy outlines how we collect, use, and safeguard your personal information when you visit our website <a href="https://bhavaniboutiques.in" className="text-primary hover:underline">bhavaniboutiques.in</a>.
                                </p>
                            </section>

            ...
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                ...
                <div className="flex-1 w-full overflow-hidden min-w-0">
                    <div className="flex items-center justify-between gap-4 md:gap-8 overflow-x-auto py-4 scrollbar-hide px-2 w-full">
                        ...
                        <Link to="/category/Kurties" className="flex flex-col items-center gap-4 md:gap-5 group shrink-0 min-w-[100px] md:min-w-[120px]">
                            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-2 border-stone-100 group-hover:border-primary group-hover:shadow-lg transition-all duration-300 p-1 bg-white">
                        ...
                        <Link to="/category/Set Mund" className="flex flex-col items-center gap-4 md:gap-5 group shrink-0 min-w-[100px] md:min-w-[120px]">
                            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-2 border-stone-100 group-hover:border-primary group-hover:shadow-lg transition-all duration-300 p-1 bg-white">
                        ...
                        <Link to="/category/Bottoms" className="flex flex-col items-center gap-4 md:gap-5 group shrink-0 min-w-[100px] md:min-w-[120px]">
                            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-2 border-stone-100 group-hover:border-primary group-hover:shadow-lg transition-all duration-300 p-1 bg-white">

...
import heritageImg from '../../assets/AboutUs1.png';
        ...
        <section className="max-w-[1200px] mx-auto py-24 px-6 grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
                ...
                <p className="text-lg text-slate-700 leading-relaxed font-light">
                    Bhavana Boutique was born from a desire to bridge the gap between ancient Kerala textile traditions and the global woman's wardrobe. We celebrate the intricate beauty of Kasavu and the timeless elegance of hand-loomed cotton.
                </p>
                <p className="text-lg text-slate-700 leading-relaxed font-light">
            ...
            <div className="relative aspect-[4/5] rounded-xl overflow-hidden shadow-2xl">
                <div
                    ...
                    style={{ backgroundImage: `url(${heritageImg})` }}
                >
                </div>
            </div>
        </section>

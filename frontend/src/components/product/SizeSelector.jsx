 ...
 * Allows users to select product size with stock availability
 */
const SizeSelector = ({ sizes, selectedSize, onSizeSelect, getStockForSize }) => {
    ...
    return (
        <div>
            <div className="flex items-center justify-between mb-3">
                ...
                <button className="text-sm text-primary hover:underline focus:outline-none focus:ring-2 focus:ring-primary rounded">
                    Size Guide
                </button>
            </div>
